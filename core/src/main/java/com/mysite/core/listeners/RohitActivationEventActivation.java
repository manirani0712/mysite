...
public class RohitActivationEventActivation implements EventListener  {

	public static final Logger log = LoggerFactory.getLogger(RohitActivationEventActivation.class);
	...
	protected void activate(ComponentContext componentContext) {
		...
		try {
			...
			session.getWorkspace().getObservationManager().addEventListener(this,
					Event.PROPERTY_ADDED | Event.NODE_ADDED, "/content/mysite", true, null, null, false);			
